...
gantt
    ...
    section Wave 1
    CARD-001 Service bootstrap & lifecycle :p1, card1, 0, 2d

    section Wave 2
    CARD-002 Provider interface & mock     :p1, card2, after card1, 1.5d

    section Wave 3
    CARD-003 Non-streaming proxy, router, health & timeouts :p1, card3, after card2, 2.5d
...
| 3 | CARD-003 | sequential | CARD-002 done |
| 4 | CARD-004, CARD-005, CARD-006, CARD-007, CARD-008, CARD-009, CARD-010 | fully parallel | CARD-003 done (CARD-010 also after CARD-001) |
| 5 | CARD-011 | sequential | CARD-007, CARD-008, CARD-009, CARD-010 all done |

## Total estimate

~23d (sequential critical path: 2 + 1.5 + 2.5 + 2.5 + 2.5 = 11d on the critical path; Wave 4 cards run in parallel)
