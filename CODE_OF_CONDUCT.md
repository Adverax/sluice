...
project maintainers privately via GitHub (the repository's **Security** tab → "Report a
vulnerability" can be used for confidential contact, or open a private message to a
