...
boundary: it maps generated DTOs ↔ canonical `provider.Request/Response`
...
| Route | AC | Notes |
|-------|----|-------|
| `POST /v1/chat/completions` | AC-001 (200), AC-003 (502), AC-004/006 (400), AC-007 (404) | OpenAPI validator fires first |
